...
x_false_train, x_false_test, y_false_train, y_false_test = train_test_split(sequence_false, y_false, test_size=0.9, random_state=100)  # 0.9，0.65
x_true_train, x_true_test, y_true_train, y_true_test = train_test_split(sequence_true, y_true, test_size=0.99, random_state=140)
